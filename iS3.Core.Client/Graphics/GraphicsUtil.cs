...
namespace iS3.Core.Client.Graphics
{
    ...
    public class GraphicsUtil
    {
            ...
            GeometryType geometryType)
        {
                ...
                || layerDef.GeometryType == GeometryType.Multipoint)
            {
                ...
                outline.Width = Double.Parse(layerDef.LineWidth.ToString());

                ISimpleMarkerSymbol symbol = 
                    Runtime.graphicEngine.newSimpleMarkerSymbol();
                symbol.Color = layerDef.Color;
                symbol.Size = Double.Parse(layerDef.MarkerSize.ToString());
            ...
            else if (layerDef.GeometryType == GeometryType.Polyline)
            {
                ...
                symbol.Width = Double.Parse(layerDef.LineWidth.ToString()) ;
