...
#iS3CoreClient=clr.LoadAssemblyFromFile('iS3.Core.Client.dll')
#clr.AddReference(iS3CoreClient)
# Import classes in IS3
from iS3.Core import (DGObject, DGObjects,Project,Domain, DomainType)
from iS3.Core.Client import (Globals, Runtime, ErrorReport, ErrorReportTarget,
                      EngineeringMap, EngineeringMapType, DrawShapeType,
                      IView, LayerDef)
from iS3.Core.Client.Geometry import *
from iS3.Core.Client.Graphics import *
