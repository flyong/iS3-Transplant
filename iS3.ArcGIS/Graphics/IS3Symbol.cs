...
namespace iS3.ArcGIS.Graphics
{
    ...
    {
        public new Core.Model.SimpleLineStyle Style
        {
            get { return (Core.Model.SimpleLineStyle)base.Style; }
    ...
    { 
        public new Core.Model.SimpleFillStyle Style
        {
            get { return (Core.Model.SimpleFillStyle)base.Style; }
    ...
    {
        public new Core.Client.Graphics.MarkerAngleAlignment AngleAlignment
        {
            get { return (Core.Client.Graphics.MarkerAngleAlignment)base.AngleAlignment; }
        ...
        public new Core.Model.SimpleMarkerStyle Style
        {
            get { return (Core.Model.SimpleMarkerStyle)base.Style; }
    ...
    public class IS3SymbolFont : SymbolFont, ISymbolFont
    {
        ...
        public new Core.Model.SymbolFontStyle FontStyle
        {
            get { return (Core.Model.SymbolFontStyle)base.FontStyle; }
            set { base.FontStyle = (Esri.ArcGISRuntime.Symbology.SymbolFontStyle)value; }
        }

        public new Core.Model.SymbolFontWeight FontWeight
        {
            get { return (Core.Model.SymbolFontWeight)base.FontWeight; }
            set { base.FontWeight = (Esri.ArcGISRuntime.Symbology.SymbolFontWeight)value; }
        }

        public new Core.Model.SymbolTextDecoration TextDecoration
        {
            get { return (Core.Model.SymbolTextDecoration)base.TextDecoration; }
    ...
    public class IS3TextSymbol : TextSymbol, ITextSymbol
    {
        ...
        public new Core.Client.Graphics.HorizontalTextAlignment HorizontalTextAlignment
        {
            get { return (Core.Client.Graphics.HorizontalTextAlignment)base.HorizontalTextAlignment;}
            set { base.HorizontalTextAlignment = (Esri.ArcGISRuntime.Symbology.HorizontalTextAlignment)value;}
        }

        public new Core.Client.Graphics.VerticalTextAlignment VerticalTextAlignment
        {
            get { return (Core.Client.Graphics.VerticalTextAlignment)base.VerticalTextAlignment;}
    ...
    public class IS3PictureMarkerSymbol: PictureMarkerSymbol, IPictureMarkerSymbol
    {
