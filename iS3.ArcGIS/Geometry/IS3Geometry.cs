...
namespace iS3.ArcGIS.Geometry
{
    ...
    public class IS3MapPoint : MapPoint, IMapPoint
    {
        ...
        public new Core.Model.GeometryType GeometryType
        {
            get { return (Core.Model.GeometryType)base.GeometryType; }
        }
    }
    ...
    public class IS3Polygon : Esri.ArcGISRuntime.Geometry.Polygon, IPolygon
    {
        // Constructor
