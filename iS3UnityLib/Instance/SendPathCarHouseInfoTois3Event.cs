...
{
    public class SendPathCarHouseInfoTois3Event : UnityEvent
    {
        /// <summary>  
        /// The Event Type Name  
        /// </summary>  
        public static UnityEventType MyEventType = UnityEventType.SendPathCarHouseInfoTois3Event;
        ...
        public SendPathCarHouseInfoTois3Event(UnityEventType aEventType) : base(aEventType)
        {
        }
