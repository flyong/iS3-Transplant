...
{
    public class SetObjStateEvent : UnityEvent
    {

        /// <summary>  
        /// The Event Type Name  
        /// </summary>  
        public static UnityEventType MyEventType = UnityEventType.SetObjStateEvent;
        ...
        public SetObjStateEvent(UnityEventType aEventType) : base(aEventType)
        {
