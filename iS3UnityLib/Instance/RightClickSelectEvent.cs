...
namespace iS3UnityLib.Model.Event
{
    ...
    /// Obj Select event.  
    /// </summary>  
    public class RightClickSelectEvent : UnityEvent
    {
        // GETTER / SETTER  
        /// <summary>  
        ...
        /// The Event Type Name  
        /// </summary>  
        public static UnityEventType MyEventType = UnityEventType.RightClickSelectEvent;
        ...
        public RightClickSelectEvent(UnityEventType aEventType) : base(aEventType)
        {
