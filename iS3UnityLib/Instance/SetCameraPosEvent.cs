...
namespace iS3UnityLib.Model.Event
{
    ...
    /// Obj Select event.  
    /// </summary>  
    public class SetCameraPosEvent : UnityEvent
    {
        ...
        /// The Event Type Name  
        /// </summary>  
        public static UnityEventType MyEventType = UnityEventType.SetCameraPosEvent;
        ...
        public SetCameraPosEvent(UnityEventType aEventType) : base(aEventType)
        {
