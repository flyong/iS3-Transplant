...
namespace iS3UnityLib.Model.Event
{
    ...
    /// Obj Select event.  
    /// </summary>  
    public class LeftClickSelectEvent : UnityEvent
    {
        // GETTER / SETTER  
        /// <summary>  
        ...
        /// The Event Type Name  
        /// </summary>  
        public static UnityEventType MyEventType = UnityEventType.LeftClickSelectEvent;
        ...
        public LeftClickSelectEvent(UnityEventType aEventType) : base(aEventType)
        {
