...
namespace iS3UnityLib.Model.Event
{
    ...
    /// Obj Select event.  
    /// </summary>  
    public class MouseOverEvent : UnityEvent
    {
        // GETTER / SETTER  
        /// <summary>  
        ...
        /// The Event Type Name  
        /// </summary>  
        public static UnityEventType MyEventType = UnityEventType.MouseOverEvent;
        ...
        public MouseOverEvent(UnityEventType aEventType) : base(aEventType)
        {
