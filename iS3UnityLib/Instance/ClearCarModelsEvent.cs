...
{
    public class ClearCarModelsEvent : UnityEvent
    {
        /// <summary>  
        /// The Event Type Name  
        /// </summary>  
        public static UnityEventType MyEventType = UnityEventType.ClearCarModelsEvent;
        ...
        public ClearCarModelsEvent(UnityEventType aEventType) : base(aEventType)
        {
        }
